...
// Adaptado por Daniel Quadros para demonstração do XIAO ESP32-C6
// * Alterado para usar botão conectado entre o GPIO 20 e GND
...
#define GPIO_INPUT_IO_TOGGLE_SWITCH GPIO_NUM_20 // GPIO_NUM_9
